...
int main(int, char**)
{
...

  {
    ...
    printf ("s_ret_double.f(-10): %d\n", s_ret_double.f(-10));
    printf ("s_ret_double.g(-10): %d\n", s_ret_double.g(-10));
    printf ("s_ret_double.f(10): %d\n", s_ret_double.f(10));
    printf ("s_ret_double.g(10): %d\n", s_ret_double.g(10));
  }
...
// { dg-output "default std::handle_contract_violation called: .*.C 9 S<int>::f .*(\n|\r\n|\r)*" }
// { dg-output "s_int.f.-10.: 10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 10 S<int>::g .*(\n|\r\n|\r)*" }
// { dg-output "s_int.g.-10.: 10(\n|\r\n|\r)*" }
// { dg-output "s_int.f.10.: -10(\n|\r\n|\r)*" }
// { dg-output "s_int.g.10.: -10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 9 S<double>::f .*(\n|\r\n|\r)*" }
...
// { dg-output "s_double.f.10.5.: -10(\n|\r\n|\r)*" }
// { dg-output "s_double.g.10.5.: -10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 28 S_arg<int>::f .*(\n|\r\n|\r)*" }
...
// { dg-output "s_arg_int.f.10.: -10(\n|\r\n|\r)*" }
// { dg-output "s_arg_int.g.10.: -10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 28 S_arg<double>::f .*(\n|\r\n|\r)*" }
...
// { dg-output "s_arg_double.f.10.: -10(\n|\r\n|\r)*" }
// { dg-output "s_arg_double.g.10.: -10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 47 S_ret<int>::f .*(\n|\r\n|\r)*" }
...
// { dg-output "s_ret_int.f.10.: -10(\n|\r\n|\r)*" }
// { dg-output "s_ret_int.g.10.: -10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 47 S_ret<double>::f .*(\n|\r\n|\r)*" }
// { dg-output "s_ret_double.f.-10.: -10(\n|\r\n|\r)*" }
// { dg-output "default std::handle_contract_violation called: .*.C 48 S_ret<double>::g .*(\n|\r\n|\r)*" }
// { dg-output "s_ret_double.g.-10.: -10(\n|\r\n|\r)*" }
// { dg-output "s_ret_double.f.10.: 10(\n|\r\n|\r)*" }
// { dg-output "s_ret_double.g.10.: 10(\n|\r\n|\r)*" }
